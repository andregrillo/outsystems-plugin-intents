...
console.log('\x1b[40m');
log(
  'Running copyExtensionFolderToIosProject hook, copying intent folder ...',
  'start'
);
...
module.exports = function(context) {
  ...
  fs.readdir(iosFolder, function(err, data) {
    ...
    var INTENT_PATH = getCordovaParameter("INTENT_PATH", contents);
    ...
    if (!fs.existsSync(srcFolder)) {
      log(
        'Missing intent folder in ' + srcFolder + '. Should have the same name as your intent: ' + intentName,
        'error'
      );
    }
    ...
    log('Successfully copied Intent folder!', 'success');
