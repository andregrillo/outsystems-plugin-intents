...
module.exports = function(context) {
    ...
    //var xcConfigPath = path.join(iosFolder, 'Config.xcconfig');
    var intentName = getCordovaParameter("INTENT_NAME",contents);
    var xcConfigPath = path.join(context.opts.projectRoot, 'www/' + intentName + '/Config.xcconfig');
